...
const FormulaInsertOrUpdate = (props) => {
    ...
    const encodeFormulaInput = () => {
        var formulaInputObj = {
            ...
            "userEmail": formulaData.userEmail
        };
        console.log("formulaInputObj on next line");
            ...
            ajax_alt("email/getAll",
                ...
                function (obj) { // obj holds role list from AJAX call
                    ...
                    if (obj.dbError.length > 0) {  // db error trying to read role list
                        ...
                        console.log("set initial role id for web_user to be "+obj.emailList[0].webUserId);
