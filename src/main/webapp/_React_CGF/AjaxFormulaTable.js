const AjaxFormulaTable = () => {

    console.log("AjaxFormulaTable running");
        ...
        <div>
          {error ? (
            ...
            <div className="clickSort">
              ...
              <FormulaFilterTable dbList={dbList} setDbList={setDbList} filteredList={filteredList} filterInput={filterInput} />
            </div>
          )}
        </div>
      );      
