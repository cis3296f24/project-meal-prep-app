...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "sp24_3308_tup13771?user=tup13771&password=chuib3Ma";
        try {
            ...
            try {
                ...
                recordError("Database Unavailable. Please contact IT support. Problem getting connection:" + e.getMessage());
            }
